 ...
 * 
 * At least one field, getter or setter in each persisted class must be marked
 * as an id.
 * 
 * @author NathanWolf
 * @see PersistClass
...
public @interface PersistField {
     ...
     * 
     * This is only valid for objects, or lists of objects. If an object is
     * contained, it is not a unique entity- its data is persisted inside of the
     * containing classes' data.
     * 
     ...
     * 
     * It's also very useful for using a hash function as id, though you should
     * be VERY careful about uniqueness in that case- id's MUST be unique.
     * 
